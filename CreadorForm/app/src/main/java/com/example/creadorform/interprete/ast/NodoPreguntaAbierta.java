 ...
 * @author mynordma
 */
public class NodoPreguntaAbierta extends NodoPregunta {
    
    private List<NodoAtributo> atributos;

    public NodoPreguntaAbierta(List atributos, int linea, int columna) {
        super(linea, columna);
    ...
    protected void imprimir(String prefijo, boolean esUltimo) {
        imprimirEncabezado(prefijo, esUltimo, "NodoPreguntaAbierta");
