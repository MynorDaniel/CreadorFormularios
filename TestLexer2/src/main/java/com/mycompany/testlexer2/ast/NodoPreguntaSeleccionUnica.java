 ...
 * @author mynordma
 */
public class NodoPreguntaSeleccionUnica extends NodoPregunta {
    
    private List<NodoAtributo> atributos;

    public NodoPreguntaSeleccionUnica(List atributos, int linea, int columna) {
        super(linea, columna);
    ...
    protected void imprimir(String prefijo, boolean esUltimo) {
        imprimirEncabezado(prefijo, esUltimo, "NodoPreguntaSeleccionUnica");
